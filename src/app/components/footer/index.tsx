            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full">
                            <img src="/images/blz-blue.png" alt="Beaker" width={32} height={32} />
                        </div>
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracki uppercase text-gray-900">Site</h3>
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="/about">About</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="/solution">Solution</a>
                            </li>
                            <li>
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="https://blazedlabs.com/privacy">Privacy</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="https://blazedlabs.com/terms">Terms of Service</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="https://blazedlabs.com/contact">Contact</a>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
