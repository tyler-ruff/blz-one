  ...
  return (
    <form onSubmit={handleSubmit} method="post" className={cn("flex flex-col gap-6", className)} {...props}>
      <FieldGroup>
        ...
        <Field>
          <Button variant="outline" onClick={() => githubLogin()} className="cursor-pointer" type="button">
          ...
          <Button variant="outline" onClick={() => googleLogin()} className="cursor-pointer" type="button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
          ...
          <Button variant="outline" onClick={() => microsoftLogin()} className="cursor-pointer" type="button">
